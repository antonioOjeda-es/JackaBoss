...
public class Empleado {
    ...
    public Empleado(Integer idEmpleado, String nombre, String apellido, String cargo,
                    Double salario, LocalDateTime fechaInicio) {
    ...
    // este le asigne el id automáticamente en la base de datos
